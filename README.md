...
| [FILE_STRUCTURE.md](docs/FILE_STRUCTURE.md) | Directory layout and conventions |
...
| [MVP_REQUIREMENTS.md](docs/MVP_REQUIREMENTS.md) | Feature scope and acceptance criteria |
