...
Native AI HTTP/credential handling, isolated Claude/Codex CLI transformations,
TexLab/LSP lifecycle and bounded JSON-RPC streaming, and the embedded PTY are
also implemented. TexLab and the AI CLIs remain optional external tools. Do not
