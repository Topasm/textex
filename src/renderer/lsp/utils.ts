...
export function lspCompletionKindToMonaco(monaco: MonacoInstance, kind: number | undefined): monacoLanguages.CompletionItemKind {
...
export function lspSymbolKindToMonaco(monaco: MonacoInstance, kind: number): monacoLanguages.SymbolKind {
