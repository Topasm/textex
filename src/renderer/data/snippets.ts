...
export const snippets: LatexSnippet[] = [
  ...
  },
  {
    label: 'Summation',
    prefix: 'sum',
    body: '\\\\sum_{${1:i=1}}^{${2:n}} ${3:expression}',
  ...
  // Preamble
  {
    label: 'Use Package',
    prefix: 'pkg',
    body: '\\\\usepackage{${1:package}}',
    description: 'Import package',
    category: 'preamble'
  },
  {
    label: 'Use Package (options)',
    prefix: 'pkgo',
    body: '\\\\usepackage[${1:options}]{${2:package}}',
    description: 'Import package with options',
    category: 'preamble'
  },
  {
    label: 'New Command',
    prefix: 'newcmd',
    body: '\\\\newcommand{\\\\${1:name}}[${2:args}]{${3:definition}}',
  ...
  },
  {
    ...
    prefix: 'docclass',
    body: '\\\\documentclass[${1:options}]{${2:article}}',
  ...
  },
  {
    ...
    prefix: 'img',
    body: '\\\\includegraphics[width=${1:0.8}\\\\textwidth]{${2:filename}}',
  ...
  },
  {
    label: 'Bibliography',
    prefix: 'bib',
    body: '\\\\bibliography{${1:references}}\n\\\\bibliographystyle{${2:plain}}',
